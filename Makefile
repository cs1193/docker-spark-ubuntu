...
build-spark-worker:
		docker build --build-arg spark_base_image=cs1193/docker-spark-base -t cs1193/docker-spark-worker -f ./images/spark-worker/spark-worker.Dockerfile .

build-spark-submit:
		docker build --build-arg spark_base_image=cs1193/docker-spark-base -t cs1193/docker-spark-submit -f ./images/spark-submit/spark-submit.Dockerfile .
